...
var canonicalLink3 = 'https://norma-studio.github.io/site-templates/portfolio.html';
var canonicalLink2 = 'https://norma-studio.github.io/site-templates/index.html';

var cl24 = '#p105', cl27 = '#p107', cl20 = '#p100';

if(canonical7+cl24 == canonicalLink2+_href7){$(".mnu span:eq(1) a").addClass("a_mnu_act");}
else if(canonical7+cl27 == canonicalLink2+_href7){$(".mnu span:eq(2) a").addClass("a_mnu_act");}
else if(canonical7+cl20 == canonicalLink2+_href7){$(".mnu span:eq(3) a").addClass("a_mnu_act");}

else if(canonical7 == canonicalLink2){$(".mnu span:eq(3) a").addClass("a_mnu_act");}
else if(canonical7 == canonicalLink3){$(".mnu span:eq(4) a").addClass("a_mnu_act");}
// console.log(canonicalLink2.slice(0, -10));
